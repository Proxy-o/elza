    ...
    <div className=" relative">
      ...
      <div className="md:h-[40rem] h-[60rem] pt-10 md:pt-0  bg-green-500 relative flex flex-col  md:items-center">
        ...
        <div className=" h-5 text-center w-full md:grid grid-cols-3 mt-10 text-yellow-100 gap-3 z-10  ">
          <div className="mx-2 mb-6 shadow-2xl border rounded-lg bg-black-400 brightness-200 bg-gradient-to-br from-orange-700 to-red-600 hover:scale-105 transition duration-200 cursor-pointer">
            <h1 className="border-b-2 py-6">Notre philosophie </h1>
            <p className="p-10">
          ...
          <div className="mx-2 mb-6 border rounded-lg bg-black-400 brightness-200 bg-gradient-to-br from-orange-700 to-red-600 hover:scale-105 transition duration-200 cursor-pointer">
            <h1 className="border-b-2 py-6">Notre philosophie </h1>
            <p className="p-10">
              Réaliser des prestations de qualité dans une recherche constante
              de la satisfaction du client
